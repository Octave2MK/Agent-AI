    ...
    <div className="bronx-page lv-snap min-h-screen w-full">
          ...
          <div className="lv-fig">
            <svg viewBox="0 0 1200 520">
              ...
              <ClaudeWin
                ...
                prompt={
                  <>
                    Je veux une équipe d&apos;employés IA pour Nonvi-Efa
      ...
      <section className="lv-slide" id="lv3">
        <div className="lv-board">
          ...
          <div className="flex flex-wrap gap-y-2">
            <div className="lv-goal">🎯 le but : qu&apos;il connaisse Nonvi-Efa par cœur, dès le premier jour</div>
              ...
              },
              {
                ...
                node: (
                  <FileWindow
                    ...
                    lines={[
                      { t: "# Nonvi-Efa — Mon équipe d'employés IA", c: "head" },
                  ...
                  <svg viewBox="0 0 1200 480">
                    ...
                    <ClaudeWin x={415} y={40} s={0.98} caption="à chaque nouvelle session, automatiquement">
                      ...
                      <g className="lv-fo" style={{ ["--d" as string]: "0s" }}>
                        ...
                        <text x="206" y="174" fontSize="14.5" fill="#5A564E">· Nonvi-Efa construit des employés IA</text>
          ...
          <div className="lv-why">
            ...
            session pour se rappeler qui est Nonvi-Efa et comment travailler. <b>Un simple document
              ...
              },
              {
                ...
                node: (
                  <FileWindow
                    ...
                    lines={[
                      { t: "# Mémoire du projet Nonvi-Efa", c: "head" },
                      { t: "" },
                      ...
                      { t: "- Nonvi-Efa ≠ agence marketing : ingénierie d'agents IA", c: "ok" },
                ...
                node: (
                  <FileWindow
                    ...
                    lines={[
                      ...
                      { t: "1. Lire clients/Nonvi-Efa/brand.md (ton, cible, règles)", c: "key" },
                      ...
                      { t: "5. Ranger dans briefs/AAAA-MM-JJ-Nonvi-Efa-....md", c: "key" },
                      { t: "" },
