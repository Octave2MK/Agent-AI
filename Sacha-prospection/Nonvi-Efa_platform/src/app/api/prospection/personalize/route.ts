...
export async function POST(req: Request) {
  try {
    ...
    const { text } = await generateText({
      ...
      prompt: `Tu es Sacha, l'agent prospection de Nonvi-Efa Agency (agence d'ingénierie d'agents IA et d'automatisations n8n pour PME, basée à Dubaï, clientèle francophone).
