...
export const metadata = {
  title: "Héberger sur un VPS · Nonvi-Efa",
  description:
          ...
          <div className="lv-fig">
            <div className="w-full max-w-[900px]">
              <div className="mb-3 flex flex-wrap items-center justify-center gap-2">
                ...
                <Arrow />
                <Box label="Le serveur" sub="/var/www/Nonvi-Efa" tone="mint" />
              </div>
              <CmdList
                where="ordi"
                items={[
                  {
                    cmd: "rsync -avz --exclude node_modules --exclude .next ./ root@46.202.173.91:/var/www/Nonvi-Efa/",
        ...
        <div className="lv-board ciel">
          ...
          <div className="lv-fig">
            <CmdList
              ...
              items={[
                {
                  cmd: "cd /var/www/Nonvi-Efa/Nonvi-Efa-platform",
        ...
        <div className="lv-board">
          ...
          <div className="lv-fig">
            <CmdList
              ...
              items={[
                {
                  cmd: "pm2 start npm --name Nonvi-Efa -- run start",
                  why: <>Démarre ton site et le confie à <b>pm2</b>. <b>--name Nonvi-Efa</b> lui donne un nom, pour pouvoir le retrouver après.</>,
                },
                {
          ...
          <div className="lv-why">
            ...
            <span className="lv-mt"> pm2 logs Nonvi-Efa</span>.
          </div>
        </div>
      </section>
          ...
          <div className="lv-fig">
            <div className="w-full max-w-[980px]">
              ...
              <CmdList
                ...
                items={[
                  {
                    cmd: "nano /etc/nginx/sites-available/Nonvi-Efa",
              ...
              <div className="mt-2.5">
                <CmdList
                  ...
                  items={[
                    {
                      cmd: "ln -s /etc/nginx/sites-available/Nonvi-Efa /etc/nginx/sites-enabled/",
            ...
            <div className="grid w-full max-w-[1060px] items-start gap-4 lg:grid-cols-[1.1fr_1fr]">
              <CmdList
                ...
                items={[
                  ...
                  {
                    cmd: "htpasswd -c /etc/nginx/.htpasswd Nonvi-Efa",
                    why: <>Crée l&apos;identifiant <b>Nonvi-Efa</b>. Il te demande alors de choisir un mot de passe (deux fois).</>,
                  },
                  {
                    cmd: "nano /etc/nginx/sites-available/Nonvi-Efa",
              ...
              <div className="space-y-3">
                <div className="rounded-2xl bg-white p-4">
                  ...
                  <ul className="space-y-2 text-[13px] text-[#3A3A3A]">
                    <li><span className="lv-mt font-bold">pm2 logs Nonvi-Efa</span><br />Le site ne s&apos;affiche pas : regarde ici, l&apos;erreur y est écrite.</li>
                    <li><span className="lv-mt font-bold">pm2 restart Nonvi-Efa</span><br />Redémarre le site s&apos;il s&apos;est bloqué.</li>
                ...
                <div className="rounded-2xl bg-white p-4">
                  ...
                  <div className="space-y-1 rounded-xl bg-[#191627] p-3 font-mono text-[11.5px] text-[#B9F0C5]">
                    <div>rsync -avz ./ root@TON_IP:/var/www/Nonvi-Efa/</div>
                    <div>cd /var/www/Nonvi-Efa/Nonvi-Efa-platform</div>
                    <div>npm ci &amp;&amp; npm run build</div>
                    <div>pm2 restart Nonvi-Efa</div>
                  </div>
                </div>
              </div>
            </div>
