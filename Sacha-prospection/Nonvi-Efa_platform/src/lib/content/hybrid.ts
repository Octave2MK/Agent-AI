...
function head(i: number, total: number): string {
  return `<div class="top"><span class="brand">Nonvi-Efa</span><span class="pg">${String(i + 1).padStart(2, "0")} / ${String(total).padStart(2, "0")}</span></div>`;
}
...
function cover(s: T1Slide, ctx: Ctx, logos: Logo[]): string {
  ...
  return `<div class="body cover">
    <div class="kick">CARROUSEL · Nonvi-Efa</div>
