...
Nonvi-Efa lance **Davide**, son agent IA de prospection, sur son propre marketing (dogfooding). Objectif SMART : **10 RDV qualifiés Calendly + 5 demandes d'intégration similaires** en 4 semaines, 100 % organique.
...
**Client** : Nonvi-Efa Agency · **Fenêtre** : 4 semaines · **Budget média** : 0 € (organique)

## 1. Contexte & objectif

Nonvi-Efa lance **Davide**, son agent IA de prospection commerciale autonome, sur son propre marketing (dogfooding). Objectif SMART : **10 RDV qualifiés bookés sur Calendly + 5 demandes d'intégration "Davide-like" en 4 semaines**, 100 % organique.

## 2. Analyse marché & concurrence

- 34 % des PME françaises utilisent déjà l'IA (France Num 2025)
- Concurrence positionnée sur l'outil (copilot) — Nonvi-Efa se positionne sur l'autonomie (agent qui tourne 24/7)
...
Et non, ce n'est pas un humain — c'est un agent IA qu'on a construit chez Nonvi-Efa.
...
C'est **leur** résultat, documenté. Pas une promesse Nonvi-Efa. Mais ça donne une idée de ce qu'un agent bien construit peut débloquer.
...
## 1. Hero campagne (16:9, cover LinkedIn page Nonvi-Efa + thumbnail YouTube)
...
**Layout** : plein cadre photo (Ideogram 16:9) + logo Nonvi-Efa en haut à droite
...
**Layout** : 3 colonnes d'icônes (Prospection / Qualification / Relance) + logo Nonvi-Efa
**Durée orale** : 120 s
...
**Layout** : tableau 3 colonnes (agences trad / no-code / Nonvi-Efa)
**Durée orale** : 60 s
...
- [ ] Palette : bleu marine \`#1E2957\` + rose nude \`#F5D5CB\`
- [ ] Logo Nonvi-Efa en pied de chaque slide
...
- Contenu technique (blog, talks) = bon pour le rayonnement Nonvi-Efa.
...
**Objet** : Entretien technique Nonvi-Efa — créneau semaine du 27/04 ?
...
**Objet** : Candidature Nonvi-Efa — suite
