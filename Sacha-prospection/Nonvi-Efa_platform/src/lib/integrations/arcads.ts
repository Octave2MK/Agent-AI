...
export class ArcadsConfigError extends Error {
  constructor() {
    super(
      "Arcads n'est pas configuré : ajoutez ARCADS_CLIENT_ID et ARCADS_CLIENT_SECRET dans Nonvi-Efa-platform/.env.local (Arcads → Settings → Public API → Generate credentials), puis relancez le serveur."
    );
