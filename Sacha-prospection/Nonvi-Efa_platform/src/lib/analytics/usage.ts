 ...
 * `analytics/usage/{slug}.jsonl` (sous le dossier racine du projet, pas Nonvi-Efa-platform).
 *
...
// Le dossier analytics/usage/ est à la racine du monorepo (pas dans Nonvi-Efa-platform/)
function usageDir(): string {
  // process.cwd() en dev = /Users/.../Nonvi-Efa-platform — on remonte d'un cran
