# Lea — Createur de contenu · Agent IA (template NAIOM)
...
2. Dans le terminal :
   ...
   npm run dev
   ```
3. Ouvre **http://localhost:3000** → tu arrives direct sur l'interface de **Lea**.

Ta clé Anthropic : https://console.anthropic.com → API Keys.

## Ce que fait Lea
Createur de contenu. Les autres agents sont visibles mais **verrouillés** (page « Débloquer les autres »).
...
- Tes livrables se rangent dans `content/`.
